...
public class AdvancedFeaturesController {
    ...
    private void analyzeTrends() {
        try {
            ...
            if (allTransactions.isEmpty()) {
                ...
                sb.append("─────────────────────────\n");
                sb.append("• Chiffre d'affaires total: ").append(String.format("%.2f DT", totalRevenue)).append("\n");
    ...
    private void syncEcommerce() {
        try {
            ...
            for (Mattress mattress : mattresses) {
                sb.append("• ").append(mattress.getType()).append(" (").append(mattress.getSize()).append(")\n");
                sb.append("  - Prix: ").append(String.format("%.2f DT", mattress.getPrix())).append("\n");
            ...
            sb.append("• Chiffre d'affaires: 15,420 DT\n");
    ...
    private void exportAccounting() {
        try {
            ...
            sb.append("💰 Montant total: ").append(String.format("%.2f DT", 
    ...
    private void connectLogistics() {
        try {
            ...
            sb.append("• Coût moyen: 12.50 DT\n\n");
            
            sb.append("🎯 OPTIONS DE LIVRAISON:\n");
            sb.append("─────────────────────────\n");
            sb.append("• Standard (3-5 jours): 8.90 DT\n");
            sb.append("• Express (1-2 jours): 15.90 DT\n");
            sb.append("• Point relais: 6.90 DT\n");
            sb.append("• Livraison à domicile: 12.90 DT\n\n");
